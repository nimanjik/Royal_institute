...
function Forgetpasswordmanager() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (newPassword !== rePassword) {
      ...
      try {
        const res = await axios.post("/managerforgetpassword", {
          username,
          newPassword,
          SecAnswer,
        });
      ...
      <div class="mainlogin">
        ...
        <div class="login">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <br/>
            <button class="reset" type="submit" className='btnloging'>RESET YOUR PASSWORD</button>
            <a href='/managerlogin'><p class="register">Already have an Account? <b>Log IN</b></p></a>
          </form>
